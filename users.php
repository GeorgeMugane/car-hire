...
<tr>
  ...
  $result = mysqli_query($con,"SELECT COUNT(*) FROM login ORDER BY id DESC  ") or die("Count query error!");
  ...
  $result = mysqli_query($con,"SELECT * FROM login ORDER BY id
...
?>
  ...
  <tr style="color: #ffffff; background: #303030;">
				...
				<td>
<a href="delete_user.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this users?')" style="text-decoration:none; color:#808080;">Delete</a>
				</td>
                </tr>
 <?php
   }
